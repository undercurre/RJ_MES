  ...
  <d2-container class="StopLineControl">
    ...
    <div class="msttable">
      <vxe-table ref="xTable"
        ...
        <vxe-table-column field="ENABLED"
          ...
          <template v-slot="{ row }">
            <el-switch v-model="row.ENABLED"
                        :disabled="$btnList.indexOf('StopLineControlEnabled') !== -1"
        ...
        <vxe-table-column :title="$t('StopLineControl._13')"
                          align="center"
                          min-width="200"
                          fixed="right">
          <template v-slot="{ row }">
  ...
  methods: {
    ...
    async GetStopLineAndCall (e) {
      ...
      if (res.Result) {
        ...
        this.ChildForm.CALL_CATEGORY_CODE = Number(data.CALL_CATEGORY_CODE) >= 0 ? Number(data.CALL_CATEGORY_CODE) : ''
        this.ChildForm.CALL_TYPE_CODE = Number(data.CALL_TYPE_CODE) >= 0 ? Number(data.CALL_TYPE_CODE) : ''
