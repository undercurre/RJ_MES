    ...
    <el-row ref="elRow1"
      ...
      <el-col :span="22">
        ...
        <el-col :span="12"
          ...
          <el-button type="primary"
                     v-if="mainTable.STATUS == 1 && $btnList.indexOf('SfcsProductMultiSaveData') !== -1"
                     @click="ConPlate">{{$t('spmr._30')}}</el-button>
          <el-button type="primary"
                    v-if="mainTable.STATUS == 1 && $btnList.indexOf('NewProductEditConfiguration') !== -1"
    ...
    <el-row ref="elrow"
      ...
      <el-col :span="12"
        ...
        <el-tabs v-model="activeName"
          ...
          <!-- 作业图  SOP维护-->
          <el-tab-pane :label="$t('ProductSetting._3')"
                       name="operation">
            ...
            <div class="AddOrModify-row-tabs">
              <el-table :data="operaTable"
                ...
                <el-table-column prop="RESOURCE_SIZE"
          ...
          <!-- 采集零件维护 -->
          <el-tab-pane v-if="$btnList.indexOf('CollectionPartsMaintenance') !== -1"
...
<!--                </vxe-table-column>-->
          ...
          <!-- 采集箱号维护 -->
          <el-tab-pane v-if="$btnList.indexOf('CollectionBoxNumberMaintenance') !== -1"
              ...
              <vxe-table ref="CaseNumber"
                ...
                <vxe-table-column show-overflow
                 ...
                 <vxe-table-column width="100"
                                  ...
                                  align="center"
                                  fixed="right"
                                  :title="$t('ProductSetting._52')">
                  <template v-slot="{ row}">
                    <el-switch v-model="row.ATTRIBUTE2"
                               :active-text="$t('publics.btn.yes')"
                               :inactive-text="$t('publics.btn.no')"
                               active-color="#13ce66"
                               inactive-color="#cccccc"
          ...
          <!-- 采集资料维护 -->
          <el-tab-pane v-if="$btnList.indexOf('CollectionDataMaintenance') !== -1"
          ...
          <!-- 采集UID维护 -->
          <el-tab-pane v-if="$btnList.indexOf('CollectUIDMaintenance') !== -1"
          ...
          <!-- 采集栈板维护 -->
          <el-tab-pane v-if="$btnList.indexOf('CollectionPalletMaintenance') !== -1"
    ...
    <el-dialog v-dialogDrag
      ...
      <div class="table-container">
        <vxe-table ref="ConfxTable"
          ...
          <vxe-table-column field="CONFIG_VALUE"
                            min-width="200"
...
import { GetConfigTypeList, SaveProductConfigData } from '@/api/SfcsProductConfig'
...
export default {
  ...
  mixins: [
    CURD({
      defaultSaveAPI: (e) => SaveProductConfigData(e)
    })
  ],
  components: {
  ...
  methods: {
    ...
    async Manufacturing () {
      ...
      // await SaveData(syssubim)
      await SaveProductConfigData(this.SystemSave)
    },
    // 添加工序
    add_process_but () {
