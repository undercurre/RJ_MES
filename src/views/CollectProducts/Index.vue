              ...
              <div class="kanban-wo-yield-panel kanban-panel-bg">
                <div class="block-center-content">
                  ...
                  <el-form ref="form"
                    ...
                    <el-form-item style="color: #fff;font-size: 16px;"
  ...
  methods: {
    ...
    async enterChange (row) {
      ...
      if (res.Result) {
        ...
        this.SiteObj = data
        this.ResultRun = Number(data.result)
        // 声音设置
        if (this.ResultRun === 0) {
          voice.success()
        }
...
.CollectProducts {
  ...
  .collstat-form .result {
    ...
    font-size: 16px;
    /* height: 100px; */
    height: calc((100vh - 380px - 0px) / 2 - 14px);
    overflow: auto;
    background: #179415;
  }
  .block-information {
