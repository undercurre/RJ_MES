      ...
      <div class="d2-multiple-page-control-content-inner">
        ...
        <el-tabs
          ...
          <el-tab-pane
            ...
            :key="page.fullPath"
            :label="($i18n.locale === 'zh-chs' ? page.meta.title : (page.fullPath === '/index' ? 'Home' : page.meta.en_title)) || $t('tabPage._6')"
            :name="page.fullPath"/>
        </el-tabs>
      </div>
    </div>
  ...
  data () {
    return {
      ...
      contextmenuListIndex: [
        { icon: 'times-circle', title: this.$t('tabPage._4'), value: 'all' }
      ],
      contextmenuList: [
        { icon: 'arrow-left', title: this.$t('tabPage._1'), value: 'left' },
        { icon: 'arrow-right', title: this.$t('tabPage._2'), value: 'right' },
        { icon: 'times', title: this.$t('tabPage._3'), value: 'other' },
        { icon: 'times-circle', title: this.$t('tabPage._4'), value: 'all' }
      ],
      tagName: '/index'
    }
    ...
    handleControlItemClick (command, tagName = null) {
      ...
      switch (command) {
        ...
        case 'all':
          ...
          break
        default:
          this.$message.error(this.$t('tabPage._5'))
          break
      }
    },
    /**
