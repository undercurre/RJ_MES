...
// 获取工单设定中的信息
export function LoadDataEX (query) {
  return request.get('SfcsWo/LoadDataEX', {
    params: query
  })
}
// 无码报工打印标签
export function NoCodeReportPrint (data) {
  return request.post('SfcsPrintTasks/NoCodeReportPrint', data)
}

// 无码报工打印标签 获取工单
export function GetProductionWO (query) {
  return request.get('SfcsWo/GetProductionWO', {
    params: query
  })
}
