  ...
  <div class="SMT1 SmtLine">
    <div class="container-fluid"
      ...
      <el-row class="kanban-title">
        <el-col :span="5">
          <span v-if="PredictTime"
                style="font-size: 16px;margin-bottom: 10px;display: block;line-height: 55px;">{{ $t("smt._14") }}：{{PredictTime}}</span>
        </el-col>
        <el-col :offset="PredictTime?0:5"
                :span="14">
            ...
            <div class="block">
              <div class="kanban-wo-yield-panel kanban-panel-bg">
                <div class="kanban-panel-title"
                     style="max-height:50px;height: 15%;display: flex;justify-content: space-between;">
                  <span>{{ $t("smt.wc") }}</span>
                </div>
                <div id="WoYieldPie"
                     style="height: 85%;" />
            ...
            <div class="block-center">
              <div class="kanban-top-defect-panel kanban-panel-bg">
                <div id="AoiTitle"
                     ...
                     style="max-height:50px;height: 15%;display: flex;justify-content: space-between;">
                  <!-- text-align: right;padding-right: 15px; style="font-size: 14px;"-->
                  {{ $t("smt.aoi") }}
                </div>
...
<script src="./SmtLine/index.js"></script>
<style scoped>
