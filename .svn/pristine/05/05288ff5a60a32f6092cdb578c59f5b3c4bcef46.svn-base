  ...
  <d2-container class="SmtLineSubstitute">
    ...
    <el-dialog v-dialogDrag
      ...
      <el-form label-position="top"
        ...
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item prop="WO_NO" :label="$t('slw.t_1')">
            ...
            <el-form-item prop="DISABLE_COMPONENT_PN" label="禁用料号">
          ...
          <el-col :span="12">
            ...
            <el-form-item prop="BEGIN_DATE" label="有效起始日期">
            ...
            <el-form-item prop="END_DATE" label="有效结束日期">
              <el-date-picker value-format="yyyy-MM-dd HH:mm:ss"
                              style="width: 100%"
