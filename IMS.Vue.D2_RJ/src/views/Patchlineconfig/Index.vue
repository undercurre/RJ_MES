            ...
            >
              <el-form ref="lineSet" size="mini" :model="lineSetForm" label-width="130px">
                ...
                <el-form-item :label="$t('Patchlineconfig._8')">
                  <el-select v-model="lineSetForm._2.VALUE">
                    <el-option
                ...
                <el-form-item :label="$t('Patchlineconfig._9')">
                  <el-input type="number" v-model="lineSetForm._3.VALUE"></el-input>
                </el-form-item>
              </el-form>
            </div>
            <div>
            ...
            >
              ...
              >
                ...
                <el-form-item :label="$t('Patchlineconfig._18')">
                  <el-select v-model="SMTSetForm._7.value" style="width: 100%">
                    <el-option
