    ...
    <template slot="header">
      <custom-container-header :isExport="false"
        ...
        <el-button type="success"
                ...
                <el-button icon="el-icon-download" type="success" @click="handleExportTpl">导出模板</el-button>
        ...
        <div>
          ...
          <el-select style="width: 150px"
            ...
            <el-option label="导入SN"
                       :value="2"></el-option>
            <el-option label="扫码镭雕"
                       :value="3"></el-option>
             <el-option label="UID镭雕码"
                       :value="4"></el-option>
          </el-select>
          <el-select style="width: 150px"
          ...
          <vxe-table ref="xTableImportInfoSon"
            ...
            <vxe-table-column show-overflow
              ...
              <vxe-table-column show-overflow
                             ...
                             <template  v-slot="{row}">
                             <div>
                             <span v-if="row.PRINT==='Y'">
                             是
                             </span>
                             <span v-else-if="row.PRINT==='N'">
                             否
                             </span>
                             <span v-else>
                             使用中
...
export default {
  ...
  data () {
    return {
      ...
      hostUri: process.env.VUE_APP_BASE_IMG
    }
  },
  created () {
  ...
  methods: {
    handleExportTpl () {
      util.open(`${this.hostUri}/upload/exceltpl/成品信息表-模板.xls`)
    },
