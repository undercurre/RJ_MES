                ...
                <div class="block-center-content">
                  ...
                  <el-form ref="form"
                    ...
                    <el-form-item :label="$t('CollectProducts._56')+ '：'"
                                  class="collstat-form-item">
                      <el-checkbox v-model="IsitPrint"></el-checkbox>
                    </el-form-item>
                  </el-form>
                </div>
...
export default {
  ...
  methods: {
    ...
    async enterChange (row) {
      ...
      this.SiteObj.PRINTCODE = this.IsitPrint
      // 工单号
      ...
      this.InputData = ''
      const res = await DoProcessMiddleCode(this.SiteObj)
