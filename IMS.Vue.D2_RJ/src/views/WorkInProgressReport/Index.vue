  ...
  methods: {
    ...
    exportClick () {
      this.$export.excel({
        columns: [
          {
            label: this.$t('_kanban._49'),
            prop: 'SN'
          },
          {
            label: this.$t('_kanban._47'),
            prop: 'STATUS'
          },
          {
            label: this.$t('_kanban._38'),
            prop: 'OPERATION_NAME'
          },
          {
            label: this.$t('_kanban._50'),
            prop: 'CARTON_NO'
          },
          {
            label: this.$t('_kanban._42'),
            prop: 'WO_NO'
          },
          {
            label: this.$t('_kanban._20'),
            prop: 'PART_NO'
          },
          {
            label: this.$t('_kanban._18'),
            prop: 'MODEL'
          },
          {
            label: this.$t('_kanban._51'),
            prop: 'WORK_TIME'
          }
        ],
        data: this.DetailData,
        title: `${this.printName}${this.$t('_kanban._48')}`
      })
      ...
      //   type: 'array'
      // })
      // downloadjs(wbout, `${this.printName}${this.$t('_kanban._48')}.xlsx`, { cellDates: true })
    },
    // 柱状图
