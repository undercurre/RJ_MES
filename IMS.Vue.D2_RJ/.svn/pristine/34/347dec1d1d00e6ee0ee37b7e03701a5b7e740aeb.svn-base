          ...
          <el-row>
            <el-col :span="12">
              <el-form-item :label="$t('ProductionSchedule._10')"
                            prop="ORDER_NO">
                <el-input v-model.trim="form.ORDER_NO"
              ...
              <el-form-item :label="$t('ProductionSchedule._7')"
                            prop="MOVEMENT">
                <el-input v-model.trim="form.MOVEMENT"
                          placeholder=" "></el-input>
              </el-form-item>
              <el-form-item :label="$t('ProductionSchedule._11')"
                            prop="ORDER_QUANTITY">
                <el-input v-model.trim="form.ORDER_QUANTITY"
                          placeholder=" "
            ...
            <el-col :span="12">
              <el-form-item :label="'计划类型'"
                            prop="PLAN_TYPE">
                <el-radio v-model.trim="form.PLAN_TYPE"
              ...
              <el-form-item :label="$t('ProductionSchedule._6')"
                ...
                <el-input placeholder=" "
                          v-model.trim="form.MACHINE_TYPE"></el-input>
              </el-form-item>
              <el-form-item :label="$t('ProductionSchedule._9')"
                            prop="NATIONALITY">
                <el-input v-model.trim="form.NATIONALITY"
                          placeholder=" "></el-input>
              </el-form-item>
