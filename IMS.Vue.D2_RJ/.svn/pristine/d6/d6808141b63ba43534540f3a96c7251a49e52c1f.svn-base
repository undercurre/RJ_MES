<template>
  <div class="locking">
    <div class="step">Step{{ consIndex }}/3</div>
    ...
    lockSave () {
      if (this.formDate.HoldCause === '') {
        ...
        if (this.flieSub) {
          ...
          if (this.groupIndex === 0 || this.groupIndex === 9) {
            this.formDate.SubsidiaryRadioGroup = this.SubsidiaryCondition && this.SubsidiaryCondition[this.SubsidiaryCondition.length - 1].LOOKUP_CODE
            console.log(this.formDate)
