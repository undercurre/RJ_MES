              ...
              <div class="kanban-wo-yield-panel kanban-panel-bg">
                <div class="block-center-content">
                  ...
                  <el-form ref="form"
                    ...
                    <el-form-item :label="$t('CollectProducts._53')"
                                  class="collstat-form-item">
                      <el-input v-model="Pallet_NO"
                                style="width: 100%;"
                                disabled
                                placfeholder=" " />
                    </el-form-item>
...
export default {
  ...
  methods: {
    ...
    ESOPPreview () {
      ...
      //   this.$message({
      //     showClose: true,
      //     message: this.$t('CollectProducts._32'),
      //     type: 'warning'
      //   })
      //   return
      // }
    ...
    async enterChange (row) {
      ...
      this.SiteObj.pallet.DefinedQty = Number(this.DefinedQty)
      // 工单号
      ...
      if (data) {
        ...
        this.Pallet_NO = data.pallet.Pallet_NO // 栈板号
        // 容量
        if (!this.DefinedQty) {
          this.DefinedQty = data.pallet.DefinedQty
        }
        this.CurrentQty = data.pallet.CurrentQty // 已装数量
    ...
    async FullClick () {
      ...
      if (!this.OldValue) {
        this.$message({
          showClose: true,
          message: this.$t('CollectProducts._52'),
          type: 'warning'
        })
        return
      }
    ...
    async getCollectProducts () {
      ...
      if (res.Result) {
        ...
        // this.HistoricalData = [
        //   {
        //     SN_No: 'TT202009190001DD',
        //     Operation_Status: 'PASS',
        //     Operation_Time: '2020-05-03 15:09:23',
        //     Operator: '陈海雄'
        //   },
        //   {
        //     SN_No: 'TT202009190001DD',
