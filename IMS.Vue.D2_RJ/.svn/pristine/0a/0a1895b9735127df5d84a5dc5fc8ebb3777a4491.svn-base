  ...
  <d2-container class="MesTongsInfo">
    <template slot="header">
      <custom-container-header importBtnName="MesTongsInfoImport"
        ...
        <el-select v-model="searchVal.ISESD" clearable class="MesTongsInfo-marginTop" style="width: 120px" :placeholder="$t('mtf._148')">
        ...
        <el-button type="success"
                   ...
                   class="MesTongsInfo-marginTop"
                   @click.prevent="toolPrint">{{ $t("mtf._145") }}</el-button>
        <el-dropdown placement="bottom" style="margin-left:10px">
           <el-button type="info">{{ $t("mtf._146") }} <i class="el-icon-arrow-down el-icon--right"></i></el-button>
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item class="serviceBtn">
              <el-button type="primary" @click="exportService('curMonth')">导出本月</el-button>
            </el-dropdown-item>
            <el-dropdown-item class="serviceBtn">
              <el-button type="primary" @click="exportService('upMonth')">导出上月</el-button>
            </el-dropdown-item>
            <el-dropdown-item class="serviceBtn">
              <el-button type="primary" @click="exportService('allMonth')">导出全部</el-button>
            </el-dropdown-item>
          </el-dropdown-menu>
        </el-dropdown>
    ...
    <!-- 工装状态 -->
        <el-table-column   prop="TONGS_STATUS"
                         :label="$t('mtf._147')"
                         align="center"
                         width="150"
                         :show-overflow-tooltip="true">
          <template slot-scope="scope">
            <span v-if="scope.row.TONGS_STATUS == 0"
                  style="color: gray; font-weight: 600">{{ $t("mtf._151") }}</span>
            <span v-else-if="scope.row.TONGS_STATUS == 1"
                  style="color: gray; font-weight: 600">{{ $t("mtf._152") }}</span>
            <span v-else-if="scope.row.TONGS_STATUS == 2"
                  style="color: gray; font-weight: 600">{{ $t("mtf._153") }}</span>
            <span v-else-if="scope.row.TONGS_STATUS == 3"
                  style="color: green; font-weight: 600">{{ $t("mtf._154") }}</span>
            <span v-else-if="scope.row.TONGS_STATUS == 4"
                  style="color: red; font-weight: 600">{{ $t("mtf._155") }}</span>
            <span v-else-if="scope.row.TONGS_STATUS == 5"
                  style="color: orange; font-weight: 600">{{ $t("mtf._156") }}</span>
            <span v-else
                  style="color: green; font-weight: 600">{{ $t("mtf._154") }}</span>
          </template>
        </el-table-column>
        <!-- 是否ESD -->
        <el-table-column   prop="ISESD"
                         :label="$t('mtf._148')"
                         align="center"
                         width="120">
            <template slot-scope="scope">
              <el-switch
                      style="width:60px"
                       v-model="scope.row.ISESD"
                       disabled
                       :active-text="$t('mtf._157')"
                       :inactive-text="$t('mtf._158')"
                       active-color="#13ce66"
          ...
          <el-table-column   prop="OPERATION_TYPE"
            ...
            <template slot-scope="scope">
              ...
              <span v-else-if="scope.row.OPERATION_TYPE == 5"
                    style="color: brown; font-weight: 600">{{ $t("mtf.t3_9") }}</span>
    ...
    <el-dialog :close-on-click-modal="false"
      ...
      <el-form :model="fixtureform"
        ...
        <el-form-item :label="$t('mtf.t4_18')">
          <el-input v-model="serviceform.DEFECT_MSG" type="textarea" disabled />
        </el-form-item>
        <el-form-item :label="$t('mtf.t4_19')">
        ...
        <el-row :gutter="24">
          <el-col :span="12">
            ...
            <el-form-item :label="$t('mtf._133')">
              <el-input type="text"
                        :placeholder="$t('mtf._149')"
                        v-model="editForm.TONGS_MODEL" />
            </el-form-item>
            <el-form-item :label="$t('mtf._134')">
              <el-input type="text"
                         :placeholder="$t('mtf._150')"
                        v-model="editForm.PRINCIPAL" />
            </el-form-item>
            <el-form-item :label="$t('mtf._147')">
              <el-select  v-model="editForm.TONGS_STATUS" style="width:100%">
                <el-option v-for="(item,index) in statesTongsList"
                :key="index"
                :label="item.CHINESE"
                :value="item.LOOKUP_CODE">
                </el-option>
          ...
          <el-col :span="12">
            ...
            <el-form-item :label="$t('mtf._148')">
              <el-radio-group v-model="editForm.ISESD">
...
<!--                            @change="partClick" />-->
                  <pn-no-select :bind-data="info2.PART_NO"
                                @getData = "setBindData"
                                :multiple = false
                  ></pn-no-select>
                </el-form-item>
...
.serviceBtn:nth-child(3){
  margin-bottom: 0px  !important;
}
.serviceBtn .el-button{
  width: 100%;
}
</style>
<style>
